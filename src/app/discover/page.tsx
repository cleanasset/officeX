    ...
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <section className="bg-[#071324] pt-20 pb-24 px-4 sm:px-6 relative overflow-hidden text-center border-b border-slate-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          <span className="px-3.5 py-1 rounded-full border border-teal-500/30 bg-teal-500/10 text-teal-300 text-[10px] sm:text-xs font-black uppercase tracking-widest mb-6 backdrop-blur-sm">
