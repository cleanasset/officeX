    ...
    <div className="flex flex-col min-h-screen bg-white font-sans overflow-x-hidden text-slate-900">
      ...
      <header className="fixed top-4 left-1/2 transform -translate-x-1/2 w-[90%] max-w-7xl z-50 bg-white/90 backdrop-blur-md border border-slate-100 rounded-full px-6 py-3 flex items-center justify-between shadow-lg">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
          <a href="#architecture" className="hover:text-[#0F8B7D] transition-colors">Our Architecture</a>
          <a href="#features" className="hover:text-[#0F8B7D] transition-colors">Features</a>
          <a href="#pricing" className="hover:text-[#0F8B7D] transition-colors">SaaS Plans</a>
          <a href="#faq" className="hover:text-[#0F8B7D] transition-colors">FAQ</a>
        </nav>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button 
            ...
            className="px-5 py-2.5 rounded-full bg-[#0F8B7D] text-white text-xs font-bold hover:bg-[#1D4ED8] shadow-[0_4px_14px_rgba(37,99,235,0.3)] transition-all cursor-pointer"
          >
            Get Started Free
          </button>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-white pt-24 px-8 flex flex-col gap-6 md:hidden">
          <a href="#architecture" className="text-lg font-bold hover:text-[#0F8B7D]" onClick={() => setMobileMenuOpen(false)}>Our Architecture</a>
          <a href="#features" className="text-lg font-bold hover:text-[#0F8B7D]" onClick={() => setMobileMenuOpen(false)}>Features</a>
          <a href="#pricing" className="text-lg font-bold hover:text-[#0F8B7D]" onClick={() => setMobileMenuOpen(false)}>SaaS Plans</a>
          <a href="#faq" className="text-lg font-bold hover:text-[#0F8B7D]" onClick={() => setMobileMenuOpen(false)}>FAQ</a>
      ...
      <section className="pt-40 pb-20 px-6 flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-b from-indigo-50/40 via-blue-50/20 to-white">
        ...
        <div className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-xs font-bold text-[#0F8B7D] shadow-xs">
        ...
        <h1 className="text-center max-w-4xl text-4xl md:text-6xl font-black tracking-tight text-slate-900 leading-[1.1]">
          ...
          <span className="bg-gradient-to-r from-[#0F8B7D] to-indigo-600 bg-clip-text text-transparent">
            Operate it smarter.
          </span>
        </h1>
        ...
        <div className="w-full max-w-3xl mt-12 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden">
            ...
            <button 
              ...
              className={`flex-1 py-4 text-xs font-extrabold border-b-2 uppercase tracking-wider transition-all ${
                activeSearchTab === "discover" 
                  ? "border-[#0F8B7D] text-[#0F8B7D] bg-white" 
          ...
          <div className="p-6 flex flex-col md:flex-row items-center gap-4">
            <div className="flex-1 w-full flex flex-col md:flex-row gap-3">
              <div className="flex-1 relative">
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-[#0F8B7D] text-xs font-semibold transition-colors"
                />
                <Search size={16} className="absolute left-3.5 top-3.5 text-slate-400" />
              </div>
              <div className="w-full md:w-48">
                <select className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-[#0F8B7D] text-xs font-bold bg-white cursor-pointer">
            ...
            <button 
              ...
              className="w-full md:w-auto px-8 py-3 rounded-xl bg-[#0F8B7D] hover:bg-[#1D4ED8] text-white text-xs font-bold shadow-md transition-colors flex items-center justify-center gap-2 cursor-pointer shrink-0"
            >
              <Search size={14} />
              Continue
            </button>
        ...
        <div className="max-w-4xl w-full grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 text-center border-t border-slate-100 pt-10">
          <div>
            <div className="text-2xl md:text-3xl font-black text-[#0F8B7D]">{animateCount.sqft}M+</div>
            <div className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-1">Sq.Ft. Managed</div>
          </div>
          <div>
            <div className="text-2xl md:text-3xl font-black text-[#0F8B7D]">{animateCount.vendors}+</div>
            <div className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-1">Verified FM Vendors</div>
          </div>
          <div>
            <div className="text-2xl md:text-3xl font-black text-[#0F8B7D]">₹{animateCount.gtv}Cr+</div>
            <div className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-1">Transaction GTV</div>
          </div>
          <div>
            <div className="text-2xl md:text-3xl font-black text-[#0F8B7D]">{animateCount.uptime}%</div>
      ...
      <section id="architecture" className="py-20 bg-slate-50 border-y border-slate-100 px-6">
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <span className="px-3 py-1 rounded bg-blue-50 border border-blue-100 text-[10px] font-bold text-[#0F8B7D] uppercase tracking-widest">Master Platform Blueprint</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-stretch">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6 p-6 rounded-3xl bg-white border border-slate-200 shadow-sm justify-between">
                  ...
                  <div 
                    ...
                    className={`p-4 rounded-2xl border text-left cursor-pointer transition-all ${
                      selectedArchNode === "property" || selectedArchNode === "lease"
                        ? "border-[#0F8B7D] bg-blue-50/20 shadow-xs" 
                        : "border-slate-150 bg-slate-50/50 hover:border-slate-300"
                    }`}
                  >
                    <div className="flex items-center gap-2">
                      <div className="p-1.5 rounded-lg bg-blue-100 text-[#0F8B7D]">
                        <Building size={14} />
                      </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-950 text-white flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-xl bg-slate-800 text-[#0F8B7D]">
                    <Database size={20} />
                  </div>
                  <div className="text-left">
                    <span className="text-[9px] font-bold text-[#0F8B7D] uppercase tracking-widest block">Shared Data Ecosystem Store</span>
            ...
            <div className="flex flex-col gap-5 p-6 rounded-3xl bg-white border border-slate-200 shadow-sm text-left">
              <div>
                ...
                <h3 className="font-black text-slate-900 text-lg mt-3 flex items-center gap-2">
                  {React.createElement(architectureNodes[selectedArchNode as keyof typeof architectureNodes].icon, { size: 20, className: "text-[#0F8B7D]" })}
              ...
              <div className="border-t border-slate-100 pt-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {architectureNodes[selectedArchNode as keyof typeof architectureNodes].fields.map((f, fIdx) => (
                    <span key={fIdx} className="px-2.5 py-1 rounded bg-slate-50 border border-slate-150 text-[10px] font-mono font-bold text-[#0F8B7D]">
                      {f}
                    </span>
                  ))}
                </div>
      ...
      <section id="features" className="py-20 px-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 md:row-span-2 rounded-3xl p-8 flex flex-col justify-between border border-slate-100 bg-gradient-to-br from-blue-50/50 to-white relative overflow-hidden group">
            ...
            <div>
              <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center text-[#0F8B7D] mb-6">
                <Building size={24} />
              </div>
              ...
              <ul className="grid grid-cols-2 gap-3 mt-6 text-xs text-slate-600 font-semibold">
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> GSTIN Auto-Check</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Verified Escrow Splits</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Structured RFQ Builder</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> SLA Penalties Tracking</li>
              </ul>
            </div>
            <a href="/public/wizard" className="inline-flex items-center gap-2 text-xs font-bold text-[#0F8B7D] mt-8 group-hover:gap-3 transition-all">
          ...
          <div>
            ...
            <div className="mt-10 flex flex-col gap-6">
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-[#0F8B7D] text-xs font-black shrink-0">1</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-[#0F8B7D] text-xs font-black shrink-0">2</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-[#0F8B7D] text-xs font-black shrink-0">3</div>
                <div>
          ...
          <div className="rounded-3xl p-8 border border-slate-100 bg-white shadow-lg relative overflow-hidden">
            ...
            <div className="flex flex-col gap-4 relative">
              <div className="p-4 rounded-xl border border-blue-100 bg-blue-50/50 flex justify-between items-center text-xs font-bold">
                ...
                <span className="text-[#0F8B7D]">₹2,18,300</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-xl border border-slate-100 bg-slate-50/50 text-center">
                  ...
                  <div className="font-black text-[#0F8B7D] mt-1">₹21,830</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="pricing" className="py-20 px-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="rounded-3xl p-8 border border-slate-100 flex flex-col justify-between bg-white">
            <div>
              ...
              <ul className="mt-8 flex flex-col gap-3 text-xs text-slate-600 font-bold">
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Public Listing Directory</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Basic Property Search</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Standard Email Support</li>
              </ul>
            </div>
          ...
          <div className="rounded-3xl p-8 border-2 border-[#0F8B7D] flex flex-col justify-between bg-white relative shadow-xl scale-105">
            <span className="absolute top-0 right-1/2 transform translate-x-1/2 -translate-y-1/2 px-4 py-1 rounded-full bg-[#0F8B7D] text-white text-[10px] font-black uppercase tracking-wider">Most Popular</span>
            <div>
              <h3 className="font-bold text-[#0F8B7D] text-xs uppercase tracking-wider">Professional</h3>
              ...
              <ul className="mt-8 flex flex-col gap-3 text-xs text-slate-600 font-bold">
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Interactive RFQ Bidding Console</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> 52-Week PPM Maintenance Calendar</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Automated Escalation Rules (60/30/15d)</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Split Escrow payments (Razorpay Route)</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Priority Chat & SLA Support</li>
              </ul>
            </div>
            <button className="w-full py-3 rounded-xl bg-[#0F8B7D] hover:bg-[#1D4ED8] text-white font-bold text-xs mt-8 transition-colors cursor-pointer">
              Choose Plan
            </button>
          </div>
          ...
          <div className="rounded-3xl p-8 border border-slate-100 flex flex-col justify-between bg-white">
            <div>
              ...
              <ul className="mt-8 flex flex-col gap-3 text-xs text-slate-600 font-bold">
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Unlimited Managed Properties</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Multi-region SLA Monitoring logs</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Dedicated Account Manager</li>
                <li className="flex items-center gap-2"><CheckCircle size={15} className="text-[#0F8B7D]" /> Custom API Access</li>
              </ul>
            </div>
            <button className="w-full py-3 rounded-xl border border-slate-200 text-slate-700 font-bold text-xs mt-8 hover:bg-slate-50 transition-colors cursor-pointer">
              Contact Sales
          ...
          <div>
            ...
            <div className="flex gap-2 mt-4">
              <input 
                ...
                className="flex-1 px-4 py-2 text-xs rounded-lg border border-slate-700 bg-slate-800 focus:outline-none focus:border-[#0F8B7D] text-white placeholder-slate-500 font-semibold"
              />
              <button className="px-4 py-2 rounded-lg bg-[#0F8B7D] text-white font-bold text-xs hover:bg-[#1D4ED8] transition-colors cursor-pointer">
                Subscribe
              </button>
            </div>
          </div>
