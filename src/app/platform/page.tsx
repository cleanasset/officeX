          ...
          <div className="mt-10 bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-sm text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 mb-8">
              {[
                ...
                { name: "Operate", sub: "CAFM & PPM", color: "#2563EB", bg: "bg-blue-50/70", border: "border-blue-200", text: "text-blue-900" },
                { name: "OfficeX Manage", sub: "Lease & CAM", color: "#7C3AED", bg: "bg-purple-50/70", border: "border-purple-200", text: "text-purple-900" },
                { name: "Intelligence & AI", sub: "Analytics & ESG", color: "#E11D48", bg: "bg-rose-50/70", border: "border-rose-200", text: "text-rose-900" }
              ].map((mod, idx) => (
                <div
                  key={idx}
