    ...
    return (
      <div className="flex flex-col gap-8 max-w-4xl mx-auto w-full font-sans">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 pb-5">
          ...
          <span className="text-xs font-bold px-3 py-1 bg-blue-50 border border-blue-100 text-[#0F8B7D] rounded-full">
            Step {step} of 5
          </span>
        </div>
          ...
          <div className="premium-card p-8 border border-gray-200 bg-white flex flex-col gap-6 shadow-sm">
                      ...
                      .map((c) => {
                        ...
                        return (
                          <button
                            ...
                            className="w-full text-left px-3 py-2 text-xs font-semibold text-gray-800 hover:bg-blue-50 hover:text-[#0F8B7D] flex items-center justify-between transition-colors cursor-pointer border-b border-gray-50"
                          >
                            <span>{c}</span>
                ...
                {imageUploadType === "upload" && (
                  <div className="mt-2 flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-2xl p-6 bg-gray-50/50 hover:bg-gray-50 transition-colors">
                    ...
                    <button
                      ...
                      className="mt-3 px-4 py-2 bg-[#0F8B7D] hover:bg-blue-700 text-white font-bold text-xs rounded-xl shadow-sm transition-colors cursor-pointer"
                    >
                      Browse Image File
                    </button>
                  </div>
                  ...
                  <div className="mt-2 flex flex-col gap-2">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#0F8B7D] hover:bg-blue-700 text-white font-bold text-xs rounded-lg shadow-sm cursor-pointer"
                      >
                        Apply Photo
                      </button>
                    </div>
            ...
            <div className="flex justify-end gap-3 border-t border-gray-100 pt-5 mt-2">
              <button 
                type="button"
                onClick={() => setStep(2)}
                className="px-6 py-2.5 rounded-xl bg-[#0F8B7D] hover:bg-blue-700 text-white font-bold text-xs shadow-md transition-colors cursor-pointer"
              >
                Next: Floors & Areas →
              </button>
            </div>
        ...
        {step === 4 && (
          <div className="premium-card p-8 border border-gray-200 bg-white flex flex-col gap-6 shadow-sm">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-100 pb-3 gap-2">
              ...
              <span className="px-3 py-1 rounded-full bg-blue-50 text-[#0F8B7D] text-xs font-extrabold border border-blue-100">
                      ...
                      return (
                        <button 
                          ...
                          className={`flex items-center justify-between p-3 rounded-xl border text-xs font-bold text-left cursor-pointer transition-all ${
                            isSelected 
                              ? "bg-blue-50 border-blue-350 bg-blue-50 text-[#0F8B7D] shadow-sm" 
            ...
            <div className="border-t border-gray-100 pt-5 flex flex-col gap-3 bg-gray-50/50 p-4 rounded-2xl">
              ...
              <form onSubmit={handleAddCustomAmenity} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-[#0F8B7D] hover:bg-blue-700 text-white font-bold text-xs rounded-lg shadow-sm transition-colors cursor-pointer"
                >
                  + Add Amenity
                </button>
              </form>
              ...
              {form.amenities.length > 0 && (
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {form.amenities.map((a) => (
                    <span 
                      key={a} 
                      className="px-2.5 py-1 rounded-full bg-blue-50 border border-blue-200 text-[10px] font-bold text-[#0F8B7D] flex items-center gap-1.5"
                    >
                      <span>✓ {a}</span>
                      <button 
                        type="button" 
          ...
          <div className="premium-card p-8 border border-gray-200 bg-white flex flex-col gap-6 shadow-sm">
            ...
            {form.amenities.length > 0 && (
              <div className="border-t border-gray-100 pt-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {form.amenities.map(a => (
                    <span key={a} className="px-2.5 py-1 rounded-full bg-blue-50 border border-blue-100 text-[9px] font-bold text-[#0F8B7D]">
                      ✓ {a}
                    </span>
                  ))}
                </div>
            ...
            <div className="flex justify-between gap-3 border-t border-gray-100 pt-5 mt-2">
              ...
              <button 
                ...
                className="px-6 py-2.5 rounded-xl bg-[#0F8B7D] hover:bg-blue-700 text-white font-extrabold text-xs shadow-md transition-colors flex items-center gap-1.5 cursor-pointer"
              >
