  ...
  return (
    <div className="flex flex-col gap-6 font-sans">
      ...
      <div className="grid grid-cols-[1fr_auto] gap-4">
        {/* Property Card */}
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden grid grid-cols-[280px_1fr]">
          ...
          <div className="p-6 flex flex-col justify-center">
            ...
            <h1 className="text-2xl font-black text-gray-900">Apex Business Tower</h1>
            <p className="text-sm text-gray-500 mt-1">Floor 5, Unit 5A</p>
        ...
        <div className="grid grid-cols-2 gap-3 w-[300px]">
          ...
          <div className="bg-gradient-to-br from-[#0F8B7D] to-[#14B8A6] rounded-2xl p-4 text-white">
            ...
            <p className="text-lg font-black">₹1,91,000</p>
            <button className="mt-2 px-3 py-1 rounded-lg bg-white/20 text-[10px] font-bold hover:bg-white/30 cursor-pointer">Pay Now</button>
          </div>
          {/* Helpdesk */}
          <div className="bg-gradient-to-br from-gray-700 to-gray-900 rounded-2xl p-4 text-white">
            ...
            <p className="text-lg font-black">2 active tickets</p>
            <button className="mt-2 px-3 py-1 rounded-lg bg-white/20 text-[10px] font-bold hover:bg-white/30 cursor-pointer">Raise Ticket</button>
          </div>
          {/* Visitors */}
          <div className="bg-gradient-to-br from-[#0F8B7D] to-[#0D7A6E] rounded-2xl p-4 text-white">
            ...
            <p className="text-lg font-black">3 expected today</p>
            <button className="mt-2 px-3 py-1 rounded-lg bg-white/20 text-[10px] font-bold hover:bg-white/30 cursor-pointer">Register</button>
          </div>
          {/* Documents */}
          <div className="bg-gradient-to-br from-gray-600 to-gray-800 rounded-2xl p-4 text-white">
            ...
            <p className="text-lg font-black">12 files in locker</p>
            <button className="mt-2 px-3 py-1 rounded-lg bg-white/20 text-[10px] font-bold hover:bg-white/30 cursor-pointer">View Files</button>
          </div>
        </div>
      </div>
