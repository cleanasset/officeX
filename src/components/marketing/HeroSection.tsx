...
export default function HeroSection({
  ...
  return (
    <section className="relative w-full pt-14 pb-18 md:pt-16 md:pb-22 px-4 sm:px-6 overflow-hidden bg-[#071324] border-b border-slate-800 text-white">
      {/* Photorealistic Commercial Real Estate Background Banner */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <Image
          ...
          sizes="100vw"
        />
        {/* Signature multi-stop navy gradient scrim: sharp typography on left, architectural visibility on right */}
