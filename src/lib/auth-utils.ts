...
export const AUTH_LOCALES = {
  en: {
    ...
    requestAccess: 'Request access / Register',
    privacy: 'Privacy',
    terms: 'Terms',
    security: 'Security',
    ...
    verifying: 'Verifying...',
    sendCodeInstead: 'Email me a one-time code instead →',
  ...
  hi: {
    ...
    requestAccess: 'पहुंच का अनुरोध करें / पंजीकरण',
    privacy: 'गोपनीयता',
    terms: 'नियम',
    security: 'सुरक्षा',
    ...
    sendCodeInstead: 'इसके बजाय ईमेल पर कोड भेजें →',
